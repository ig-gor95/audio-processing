...
def run_pipeline(audio_file: Path):
    ...
    elif existing_dialog.status == AudioDialogStatus.PROCESSED and existing_dialog.updated_at < datetime(2025, 9, 6):
...
def process_files_parallel(audio_files: List[Path], max_workers: int = 5, max_files: int = 2000):
